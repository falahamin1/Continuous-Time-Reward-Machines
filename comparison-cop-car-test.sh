...
python3 Comparison.py --env cop-car --specify_dimension yes --rows 7 --columns 7 --runs 30 --threshold 0.9 --max_episodes 100000 --save_file cop-car-deeprl-server --buffer_size 50000 --save_data copcar-deeprl-server-data
