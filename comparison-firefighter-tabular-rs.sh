...
#SBATCH --nodes=1
#SBATCH --time=18:00:00                # Adjust the time as needed (e.g., 2 hours)
...
python3 Comparison.py --env firefighter-car --reward_shaping yes --specify_dimension yes --rows 7 --columns 7 --runs 5 --threshold 0.8 --max_episodes 25000 --update_frequency 10 --discount_factor 0.105 --episode_len 1000 --learning_rate 0.2 --save_file firefighter-tabular-server-rs --buffer_size 75000  --save_data firefighter-tabular-server-data-rs --deep_rl no
