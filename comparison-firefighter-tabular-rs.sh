...
python3 Comparison.py --env firefighter-car --reward_shaping yes --specify_dimension yes --rows 7 --columns 7 --runs 10 --threshold 0.8 --max_episodes 30000 --update_frequency 10 --discount_factor 0.01 --episode_len 1000 --learning_rate 0.7 --save_file firefighter-tabular-server --buffer_size 75000  --save_data firefighter-tabular-server-data --deep_rl no
