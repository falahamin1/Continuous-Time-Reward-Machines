...
#SBATCH --nodes=1
#SBATCH --time=20:00:00                # Adjust the time as needed (e.g., 2 hours)
...
python3 Comparison.py --env firefighter-car --specify_dimension yes --rows 7 --columns 7 --runs 20 --threshold 0.85 --max_episodes 20000 --episode_len 500 --update_frequency 10 --discount_factor 0.065 --save_file firefighter-tabular-server --buffer_size 75000  --save_data firefighter-tabular-server-data --deep_rl no
