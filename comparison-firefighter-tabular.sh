...
python3 Comparison.py --env firefighter-car --specify_dimension yes --rows 7 --columns 7 --runs 15 --threshold 0.8 --max_episodes 90000 --episode_len 500 --update_frequency 10 --discount_factor 0.035 --learning_rate 0.5 --save_file firefighter-tabular-server --buffer_size 75000  --save_data firefighter-tabular-server-data --deep_rl no
