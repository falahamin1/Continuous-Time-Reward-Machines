...
python3 Comparison.py --env cop-car --specify_dimension yes --rows 11 --columns 11 --runs 10 --threshold 0.9 --max_episodes 10000 --episode_len 1000 --discount_factor 0.001 --save_file copcar-server-tabular-rs --buffer_size 50000 --save_data copcar-server-tabular-data-rs --deep_rl no --update_frequency 10 --reward_shaping yes
