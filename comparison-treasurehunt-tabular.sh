...
python3 Comparison.py --env treasure-map --specify_dimension yes --rows 11 --columns 11 --runs 5 --reward_shaping no --threshold 0.9 --max_episodes 20000 --episode_len 1000 --update_frequency 5 --discount_factor 0.001  --save_file treasurehunt-tabular-server-large --buffer_size 50000 --save_data treasurehunt-server-tabular-data-large --deep_rl no
