...
python3 Comparison.py --env treasure-map --specify_dimension yes --rows 7 --columns 7 --runs 15 --threshold 0.9 --max_episodes 20000 --episode_len 500 --update_frequency 10 --discount_factor 0.045  --save_file treasurehunt-tabular-server --buffer_size 50000 --save_data treasurehunt-server-tabular-data --deep_rl no
