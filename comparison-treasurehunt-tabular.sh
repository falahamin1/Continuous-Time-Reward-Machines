...
python3 Comparison.py --env treasure-map --specify_dimension yes --rows 7 --columns 7 --runs 20 --threshold 0.9 --max_episodes 10000 --update_frequency 10 --discount_factor 0.035  --save_file treasurehunt-tabular-server --buffer_size 50000 --save_data treasurehunt-server-tabular-data --deep_rl no
