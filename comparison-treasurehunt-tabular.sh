...
python3 Comparison.py --env treasure-map --specify_dimension yes --rows 7 --columns 7 --runs 25 --threshold 0.9 --max_episodes 75000 --save_file treasurehunt-tabular-server --buffer_size 50000 --save_data treasurehunt-server-tabular-data --deep_rl no
