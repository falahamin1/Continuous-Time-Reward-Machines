...
class CopCarEnv():
    def __init__(self, rows, cols, probability):
        self.initstate = (0,0,0,0)  #Starting at (0,0) with atomic propositions siren and theif set to false
