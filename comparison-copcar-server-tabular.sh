...
#SBATCH --nodes=1
#SBATCH --time= 00:15:00                # Adjust the time as needed (e.g., 2 hours)
...
python3 Comparison.py --env cop-car --specify_dimension yes --rows 7 --columns 7 --runs 20 --threshold 0.9 --max_episodes 1000 --episode_len 500 --discount_factor 0.05 --save_file copcar-server-tabular --buffer_size 50000 --save_data copcar-server-tabular-data --deep_rl no --update_frequency 5
