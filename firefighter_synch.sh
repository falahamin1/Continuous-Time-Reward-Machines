...
python3 Comparison.py --env firefighter-synch --specify_dimension yes --rows 5 --columns 5 --runs 20 --threshold 0.85 --max_episodes 100000 --save_file firefightersynch-deeprl-server --buffer_size 75000 --save_data firefightersynch-deeprl-server-data
