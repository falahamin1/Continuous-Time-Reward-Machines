...
class DeepRLClassic():
    ...
    max_episode_length = 1000, update_length = 64, number_of_episodes = 5000, UPDATE_FREQUENCY = 50, hard_update_frequency = 5, env = None, ctrm = None, decay_rate = 0.05):
    ...
    def doRL(self):
        ...
        for i in range (self.number_of_episodes): 
            ...
            for j in range(self.max_episode_length):
                ...
                if reward is None: #final state reached, no transitions available
                    break
    ...
    def doRLwithconvergence (self, value, threshold, max_episodes):
        k = 0
        sum_perfomance = 0
        termination = 0
        i = 0
    ...
    # if (i + 1) % hard_update_frequency == 0:
    #     optimizer.update_target_hard()
