...
python3 Comparison.py --env firefighter-car --specify_dimension yes --rows 5 --columns 5 --runs 20 --threshold 0.85 --max_episodes 100000 --save_file firefighter-deeprl-server --buffer_size 75000 --discount_factor 0.0001 --save_data firefighter-deeprl-server-data
