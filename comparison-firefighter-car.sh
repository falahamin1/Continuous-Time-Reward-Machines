...
python3 Comparison.py --env firefighter-car --specify_dimension yes --rows 7 --columns 7 --runs 30 --threshold 0.85 --max_episodes 100000 --save_file firefighter-comparison-server --buffer_size 75000 --save_data firefighter-comparison-server-data
