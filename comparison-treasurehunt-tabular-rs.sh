...
python3 Comparison.py --env treasure-map --specify_dimension yes --rows 11 --columns 11 --runs 5 --reward_shaping yes --threshold 0.9 --max_episodes 20000 --episode_len 1000 --update_frequency 10 --discount_factor 0.001  --save_file treasurehunt-tabular-server-rs-large --buffer_size 50000 --save_data treasurehunt-server-tabular-data-rs-large --deep_rl no
